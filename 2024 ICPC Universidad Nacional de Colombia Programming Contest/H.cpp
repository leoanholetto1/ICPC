...
void solve(){
	...
	if(a+c > b){
		a+=c;
		if(b<=1199 && a>1199 && a<=1399) cout << "pupil" << endl;
		else if(b<=1399 && a>1399 && a<=1599) cout << "specialist" << endl;
		else if(b<=1599 && a>1599 && a<=1899) cout << "expert" << endl;
		else if(b<=1899 && a>1899 && a<=2099) cout << "candidate master" << endl;
		else if(b<=2099 && a>2099 && a<=2399) cout << "master" << endl;
		else if(b<=2399 && a>2399) cout << "grandmaster" << endl;
